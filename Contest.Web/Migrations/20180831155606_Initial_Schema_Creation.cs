...
{
    public partial class Initial_Schema_Creation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalScoreEarned = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeMail = table.Column<string>(nullable: true),
                    Inumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ThreadHash = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true),
                    OverallRating = table.Column<byte>(nullable: false),
                    Good = table.Column<string>(nullable: true),
                    Ok = table.Column<string>(nullable: true),
                    Bad = table.Column<string>(nullable: true),
                    InterestedInFuture = table.Column<bool>(nullable: false),
                    FutureTheme = table.Column<string>(nullable: true),
                    ExpectedFeatures = table.Column<string>(nullable: true),
                    SelectedFeatures = table.Column<string>(nullable: true),
                    JudgingProcessImprovements = table.Column<string>(nullable: true),
                    SurveyThreadId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {

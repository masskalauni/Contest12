...
namespace Contest.Web.Migrations
{
    ...
    [Migration("20180903072606_Team_And_Participant_Fields_Added")]
    partial class Team_And_Participant_Fields_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.Participant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<float>("FinalScoreEarned");
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.TeamScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<float>("WeightedAverageScore");
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.Participant", b =>
                {
                    b.HasOne("Contest.Models.ScoreCard.Team")
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.Team", b =>
                {
                    b.HasOne("Contest.Models.ScoreCard.Participant", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Contest.Models.ScoreCard.TeamScore", b =>
                {
                    ...
                    b.HasOne("Contest.Models.ScoreCard.Team", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId")
